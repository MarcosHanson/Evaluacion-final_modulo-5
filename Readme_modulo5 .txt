...
***************
GitHub individual: 
https://github.com/fcastitt/Evaluacion-final_modulo-5.git
https://github.com/elegangsters/Evaluacion-final_modulo-5
https://github.com/MarcosHanson/Evaluacion-final_modulo-5.git
https://github.com/HugoLopezug/Evaluacion-final_modulo-5.git

***************
Github general:
https://github.com/fcastitt/Evaluacion-final_modulo-5_front.git
https://github.com/fcastitt/Evaluacion-final_modulo-5_back.git
...
- Listado que permita agregar o eliminar los asistentes de una capacitacion.
- Acceso a un usuario mediante su RUT y clave.
- Listado de todos los accidentes registrados en la plataforma.
- Listado de chequeos realizados a cada cliente en terreno.

Todo lo anterior considerando responsividad para al menos 3 dispositivos.

Para navegar dentro de la aplicaci—n es necesario desactivar la seguridad desde: WebConfiguracionSeguridad.java
